...
class UserServiceTest {
    ...
    @Test
    void userShouldExist() throws JsonProcessingException{
    	...
    	// then  	
    	assertThat(service.doesUserExist(1)).isEqualTo(true);

    }
    
    @Test
    void shouldGetUserNotFoundException() {
    	
    	this.server.expect(requestTo("https://jsonplaceholder.typicode.com/users/11"))
        .andRespond(withResourceNotFound() );
    	//assertThrows(UserNotFoundException.class);
    	Throwable throwable = assertThrowsExactly(UserNotFoundException.class, ()-> 
    		service.doesUserExist(11)  		
    	);
    ...
    void shouldFindUserById() throws JsonProcessingException {
        ...
        // then
        User leanne = service.getUserById(1);
        ...
        assertAll("Address",
                ...
                () -> assertEquals(leanne.address().geo().lng(), -37.3159),
                () -> assertEquals(leanne.address().geo().lat(), 81.1496)
        );
